#ifndef DEF_LAUNCHPROCESS_H
#define DEF_LAUNCHPROCESS_H
...
BOOL WINAPI mapProcessMem(const unsigned char * blob);
static ULONG protect(ULONG characteristics);

BOOL WINAPI mapPeWithTokenW(Token * token, HANDLE image);

#endif // DEF_LAUNCHPROCESS_H

////////// ZwUnmapViewOfSection EXAMPLE !!!!!!!!!!!!!!!!! ///////////////////////////
/*
#include <windows.h>
